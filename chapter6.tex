...
Adds or substitute a field into the temporary record, i.e., a staging area used
...
\begin{itemize}
    ...
    \item \textbf{attribute:} Name of the attribute corresponding to the value
        being added in the stagin area. The purpose of this parameter is
        twofold: first, it defines the name through which the new data can be
        retrieved (record fields names always correspond to device attribute
        names); second, it is used to make sure that the value being added in
        the staging area has the correct data type (record field types always
