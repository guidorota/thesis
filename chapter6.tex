...
Every \texttt{Message} type available in the PerLa Middleware is managed using
a \texttt{Mapper}, a Middleware component that can be used to create

The \texttt{Mapper} component is responsible for the management of the entire
lifecycle of \texttt{Message} objects. Its interface, shown in
