...
IORequest is the object that allows users to specify which operation has to be performed by a channel.

Since different channels are built over different communication technologies, each channel comes with its particular IOReqeust imlementation (HTTPIORequest, SerialIORequest)
