...
specified using a proprietary XML syntax, specifically designed to allow the
inclusion of PerLa \texttt{Scripts} directly in a Device Descriptor. Conflicts
with potentially similar XML elements and tags are avoided through the
...
maintain this convention, as the use of a different namespace prefix may create
confusion among end users and future Device Descriptor mainteners. 

\texttt{Script} instructions are composed of a \textit{name} and a list of
\textit{parameters}.
