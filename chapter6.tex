...
period of time, as their execution is triggered by each new sample collected
from the sensing network. To better cope with this usage scenario, the
\texttt{Script Engine} implements a thread caching mechanism designed to reduce
both memory usage and \texttt{Script} startup time. 
