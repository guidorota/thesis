...
PerLa Script is a full-fledged imperative programming language composed of data
management instructions, control flow statements and a powerful expression
language. Procedures written in PerLa Script are processed by the
\texttt{Script Engine}, a Middleware module that reads, interpret and executes
Script instructions.
