...
associated with the \texttt{<i:} prefix. Node developers are invited to follow
this convention, as the use of a different namespace prefix may create
...
are simple string values, whose  
