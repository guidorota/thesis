...
this document, provide the kind of structural scaffolding required to organize
a series of primitive data management operations into a self-contained,
reuseable procedure. Their purpose in the PerLa Middleware is twofold: first,
to issue commands to the devices of a Pervasive Systems; second, to act as an
impedance matcher between the message-oriented environment of a sensor network
and the record-oriented world of PerLa. While the former function has been
thoroughly explained in the previous paragraph, the latter needs 
